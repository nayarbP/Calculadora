...
public class Interface extends javax.swing.JFrame {
    ...
    // Asegurarse de que el JFrame pueda recibir el foco
    setFocusable(true);
    requestFocus();
    }
...
protected void processKeyEvent(KeyEvent e) {
    if (e.getID() != KeyEvent.KEY_PRESSED) {
        return; // Solo procesar eventos KEY_PRESSED
    }
    char keyChar = e.getKeyChar();
    int keyCode = e.getKeyCode();

    if (Character.isDigit(keyChar)) {
        txt_Operacion.setText(txt_Operacion.getText() + keyChar);
        ...
        btn_RecorrerActionPerformed(null);
    } else if (keyCode == KeyEvent.VK_ESCAPE) {
        btn_BorrarpantallaActionPerformed(null);
    }
    ...
    private void btn_BorrarpantallaActionPerformed(java.awt.event.ActionEvent evt) {                                                   
        txt_Operacion.setText(""); 
        txt_Resultado.setText("");          
    // Arregalo Boton Borrar           
    }                                                  

    private void btn_BorrarentradaActionPerformed(java.awt.event.ActionEvent evt) {                                                  
        String operacion = txt_Operacion.getText();
        if (!operacion.isEmpty()) {
    ...
    private void btn_RecorrerActionPerformed(java.awt.event.ActionEvent evt) {                                             
        String operacion = txt_Operacion.getText(); 
    ...
    private void btn_MultiplicacionActionPerformed(java.awt.event.ActionEvent evt) {                                                   
